...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 z-50 h-screen w-64 bg-charcoal border-r border-bgGray flex flex-col transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
        
        <div className="p-6 flex items-center gap-2">
          <div className="bg-mutedOrange w-8 h-8 rounded-lg flex items-center justify-center text-white font-bold">
              ST
          </div>
          <span className="text-xl font-bold text-white">SchoolTrack</span>
        </div>
            ...
            return (
              <Link 
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors duration-200 
                  ${isActive 
                    ? "bg-mutedOrange text-white font-semibold" 
                    : "text-white hover:bg-lightCharcoal"
                  }`}
        ...
        <div className="p-4">
          <button 
              ...
              className="flex items-center gap-3 px-4 py-3 w-full text-white hover:bg-lightCharcoal rounded-lg transition-colors cursor-pointer"
          >
              <FaSignOutAlt />
              <span>Logout</span>
          </button>
